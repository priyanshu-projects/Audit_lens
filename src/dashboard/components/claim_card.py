"""
src/dashboard/components/claim_card.py
========================================
Claim card component — renders a single claim with metadata badges.
"""
...
def render_claim_card(item: dict, idx: int) -> None:
    """
    Render a structured claim card with metadata.

    Args:
        item: Processed claim dict from session state
        idx:  0-based index in claims list
    """
    claim  = item["claim"]
