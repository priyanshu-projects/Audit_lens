...
class QueryRequest(BaseModel):
    ...
    filters: Optional[Dict[str, str]] = Field(None, example={'esg_label': 'E', 'document': 'aapl-20240928'})
...
class VerifyRequest(BaseModel):
    claim_ids: Optional[List[int]] = Field(None, description='If omitted, verifies all loaded claims.')
