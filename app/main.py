...
app = FastAPI(title='AuditLens API', description='Intelligent ESG Audit Assistant — extracts, verifies, and queries ESG claims from corporate filings using RAG + FinBERT + Gemini.', version='1.0.0', lifespan=lifespan, docs_url='/docs', redoc_url='/redoc')
...
async def root():
    return {'service': 'AuditLens API', 'version': '1.0.0', 'docs': '/docs'}